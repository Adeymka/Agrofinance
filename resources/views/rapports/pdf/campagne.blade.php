...
@php use App\Support\IndicateursLibelles; @endphp
    ...
    <div class="entete">
        ...
        <div class="sous-titre">Rapport de campagne agricole — généré le {{ now()->format('d/m/Y à H:i') }}</div>
    </div>
    ...
    <table>
        ...
        <tr><td><strong>Période</strong></td>
    ...
    <div class="pied-page">
        AgroFinance+ — Rapport généré automatiquement — Valide pour présentation en microfinance<br>
        Lien de partage valable 72h — {{ rtrim(config('app.url'), '/') }}/partage/{{ $rapport->lien_token }}
    </div>
