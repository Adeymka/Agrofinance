    ...
    <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto text-sm">
        @php
            $links = [
                ...
                ['key' => 'campagnes', 'label' => 'Campagnes', 'href' => route('activites.index', array_filter(['exploitation_id' => $exploitationNavId ?? null])), 'icon' => 'leaf'],
                ['key' => 'nouvelle-campagne', 'label' => 'Nouvelle campagne', 'href' => route('activites.create', array_filter(['exploitation_id' => $exploitationNavId ?? null])), 'icon' => 'plus-circle'],
