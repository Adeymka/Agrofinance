...
<p style="font-family:'Inter',sans-serif; font-size:15px;
    ...
    <span style="color:rgba(255,255,255,0.75); font-weight:600;">
        {{ $telephone }}
    </span>
</p>
...
<div style="display:flex; align-items:center; gap:12px; padding:16px;
    ...
    <div>
        <div style="font-family:'Inter',sans-serif; font-size:13px; font-weight:600;
                    color:rgba(255,255,255,0.80); margin-bottom:2px;">Code valable 10 minutes</div>
        <div style="font-family:'Inter',sans-serif; font-size:12px;
                    color:rgba(255,255,255,0.35);">5 tentatives maximum avant blocage</div>
    </div>
</div>
...
@if (app()->environment('local'))
    <div style="margin-top:20px; padding:12px 16px;
        ...
        <div style="font-family:'Inter',sans-serif; font-size:12px; font-weight:600;
                    color:rgba(245,158,11,0.80); margin-bottom:4px;">Mode développement</div>
...
<div class="step-indicator">
    ...
    <div class="step-item">
        ...
        <div class="step-label active">OTP</div>
    </div>
...
@if (session('info'))
    <div class="auth-success" style="color:#fcd34d; border-color:rgba(251,191,36,0.35); background:rgba(245,158,11,0.12);">
        {{ session('info') }}
    </div>
@endif
@if ($errors->any())
...
<form method="POST" action="{{ route('renvoyer.otp') }}" style="margin-top:16px;">
    ...
    <button type="submit" style="width:100%; background:transparent; border:none;
                                  ...
                                  color:rgba(255,255,255,0.38); cursor:pointer; padding:10px;">
        Pas reçu ?
        <span class="auth-link" style="background:none;border:none;padding:0;font:inherit;">Renvoyer le code</span>
    </button>
</form>
@endsection
